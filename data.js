...
const characters = ["Lyn", "Lyn (E/H)", "Sain", "Sain (E/H)", "Kent", "Kent (E/H)", "Florina", "Florina (E/H)", "Wil", "Wil (E/H)", "Dorcas", "Serra", "Erk", "Erk (E/H)", "Rath", "Rath (E/H)", "Matthew", "Nils/Ninian", 
	"Lucius", "Lucius (E/H)", "Wallace", "Wallace (E/H)", "Eliwood", "Marcus", "Lowen", "Rebecca", "Bartre", "Hector", "Oswin", "Guy", "Guy (Hard)", "Merlinus", "Priscilla", "Raven", "Raven (Hard)",  "Canas", "Dart", "Fiora", 
	"Legault", "Legault (Hard)", "Isadora", "Heath", "Heath (Hard)", "Hawkeye", "Geitz", "Geitz (Hard)", "Farina", "Pent", "Louise", "Karel", "Harken", "Harken (Hard)", "Nino", "Jaffar", "Vaida", "Vaida (Hard)", "Karla", "Renault", "Athos"];

const charGrowths = new Map([
	["Lyn", 			[70, 40, 60, 60, 55, 20, 30, 0, 0]],
	["Lyn (E/H)", 		[70, 40, 60, 60, 55, 20, 30, 0, 0]],
	["Sain", 			[80, 60, 35, 40, 35, 20, 20, 0, 0]],
	["Sain (E/H)", 		[80, 60, 35, 40, 35, 20, 20, 0, 0]],
	["Kent", 			[85, 40, 50, 45, 20, 25, 25, 0, 0]],
	["Kent (E/H)", 		[85, 40, 50, 45, 20, 25, 25, 0, 0]],
	["Florina", 		[60, 40, 50, 55, 50, 15, 35, 0, 0]],
	["Florina (E/H)", 	[60, 40, 50, 55, 50, 15, 35, 0, 0]],
	["Wil", 			[75, 50, 50, 40, 40, 20, 25, 0, 0]],
	["Wil (E/H)", 		[75, 50, 50, 40, 40, 20, 25, 0, 0]],
	["Dorcas",			[80, 60, 40, 20, 45, 25, 15, 0, 0]],
	["Serra", 			[50, 50, 30, 40, 60, 15, 55, 0, 0]],
	["Erk", 			[65, 40, 40, 50, 30, 20, 40, 0, 0]],
	["Erk (E/H)", 		[65, 40, 40, 50, 30, 20, 40, 0, 0]],
	["Rath", 			[80, 50, 40, 50, 30, 10, 25, 0, 0]],
	["Rath (E/H)", 		[80, 50, 40, 50, 30, 10, 25, 0, 0]],
	["Matthew", 		[75, 30, 40, 70, 50, 25, 20, 0, 0]],
	["Nils/Ninian", 	[85,  5,  5, 70, 80, 30, 70, 0, 0]],
	["Lucius", 			[55, 60, 50, 40, 20, 10, 60, 0, 0]],
	["Lucius (E/H)", 	[55, 60, 50, 40, 20, 10, 60, 0, 0]],
	["Wallace", 		[70, 45, 40, 20, 30, 35, 35, 0, 0]],
	["Wallace (E/H)", 	[70, 45, 40, 20, 30, 35, 35, 0, 0]],
	["Eliwood", 		[80, 45, 50, 40, 45, 30, 35, 0, 0]],
	["Marcus", 			[65, 30, 50, 25, 30, 15, 35, 0, 0]],
	["Lowen", 			[90, 30, 35, 30, 50, 50, 35, 0, 0]],
	["Rebecca", 		[60, 40, 50, 65, 50, 15, 30, 0, 0]],
	["Bartre", 			[90, 55, 35, 45, 40, 30, 25, 0, 0]],
	["Hector", 			[90, 60, 45, 35, 30, 50, 25, 0, 0]],
	["Oswin", 			[90, 55, 30, 30, 35, 55, 30, 0, 0]],
	["Guy", 			[75, 35, 50, 70, 45, 15, 25, 0, 0]],
	["Guy (Hard)", 		[75, 35, 50, 70, 45, 15, 25, 0, 0]],
	...
	["Canas", 			[70, 45, 40, 35, 25, 25, 45, 0, 0]],
	...
	["Isadora", 		[75, 30, 35, 50, 45, 20, 25, 0, 0]],
...
const charBases = new Map([
	["Lyn", 			[ 1, 16,  4,  7,  8,  5,  2,  0,  5,  5]],
	["Lyn (E/H)", 		[ 4, 18,  5, 10, 11,  5,  2,  0,  5,  5]],
	["Sain", 			[ 1, 19,  8,  4,  6,  4,  6,  0,  9,  7]],
	["Sain (E/H)", 		[ 4, 22,  9,  5,  7,  5,  7,  0,  9,  7]],
	["Kent", 			[ 1, 20,  6,  6,  7,  2,  5,  1,  9,  7]],
	["Kent (E/H)", 		[ 5, 23,  8,  7,  8,  4,  6,  1,  9,  7]],
	["Florina", 		[ 1, 17,  5,  7,  9,  7,  4,  4,  4,  7]],
	["Florina (E/H)", 	[ 3, 18,  6,  8,  9,  8,  4,  5,  4,  7]],
	["Wil", 			[ 2, 20,  6,  5,  5,  6,  5,  0,  6,  5]],
	["Wil (E/H)", 		[ 4, 21,  6,  5,  6,  7,  5,  1,  6,  5]],
	["Dorcas",			[ 3, 30,  7,  7,  6,  3,  3,  0, 14,  5]],
	["Serra", 			[ 1, 17,  2,  5,  8,  6,  2,  5,  4,  5]],
	["Erk", 			[ 1, 17,  5,  6,  7,  3,  2,  4,  5,  5]],
	["Erk (E/H)", 		[ 1, 17,  5,  6,  7,  3,  2,  4,  5,  5]],
	["Rath", 			[ 7, 25,  8,  9, 10,  5,  7,  2,  8,  7]],
	["Rath (E/H)", 		[ 9, 27,  9, 10, 11,  5,  8,  2,  7,  7]],
	["Matthew", 		[ 2, 18,  4,  4, 11,  2,  3,  0,  7,  6]],
	["Nils/Ninian", 	[ 1, 14,  0,  0, 12, 10,  5,  4,  3,  5]],
	["Lucius", 			[ 3, 18,  7,  6, 10,  2,  1,  6,  6,  5]],
	["Lucius (E/H)", 	[ 3, 18,  7,  6, 10,  2,  1,  6,  6,  5]],
	["Wallace", 		[12, 30, 13,  7,  5, 10, 15,  4, 13,  4]],
	["Wallace (E/H)", 	[ 1, 34, 16,  9,  8, 10, 19,  7, 15,  5]],
	["Eliwood", 		[ 1, 18,  5,  5,  7,  7,  5,  0,  7,  5]],
	["Marcus", 			[ 1, 31, 15, 15, 11,  8, 10,  8, 11,  8]],
	["Lowen", 			[ 2, 23,  7,  6,  7,  3,  8,  1, 11,  7]],
	["Rebecca", 		[ 1, 17,  5,  5,  9,  4,  3,  1,  6,  5]],
	["Bartre", 			[ 2, 30, 10,  6,  6,  5,  5,  1, 13,  5]],
	["Hector", 			[ 1, 19,  7,  4,  5,  3,  8,  0, 13,  5]],
	["Oswin", 			[ 9, 28, 13,  9,  5,  3, 13,  3, 14,  4]],
	["Guy", 			[ 3, 21,  6, 11, 11,  5,  5,  0,  7,  5]],
	["Guy (Hard)", 		[ 3, 25,  8, 13, 13,  5,  6,  2,  7,  5]],
	["Merlinus", 		[ 7, 18,  0,  4,  5, 12,  5,  2, 25,  0]],
	["Priscilla", 		[ 3, 16,  6,  6,  7,  7,  3,  6,  4,  7]],
	["Raven", 			[ 5, 25,  8, 11, 13,  2,  5,  1,  8,  5]],
	["Raven (Hard)", 	[ 5, 29, 10, 13, 15,  2,  6,  2,  8,  5]],
	["Canas", 			[ 8, 21, 10,  9,  8,  7,  5,  8,  7,  5]],
	["Dart", 			[ 8, 34, 12,  8,  8,  3,  6,  1, 10,  5]],
	["Fiora", 			[ 7, 21,  8, 11, 13,  6,  6,  7,  5,  7]],
	["Legault", 		[12, 26,  8, 11, 15, 10,  8,  3,  9,  6]],
	["Legault (Hard)", 	[12, 29,  8, 13, 17, 10,  8,  4,  9,  6]],
	["Isadora", 		[ 1, 28, 13, 12, 16, 10,  8,  6,  6,  8]],
	["Heath", 			[ 7, 28, 11,  8,  7,  7, 10,  1,  9,  7]],
	["Heath (Hard)", 	[ 7, 32, 13, 10,  9,  7, 11,  2 , 9,  7]],
	["Hawkeye", 		[ 4, 50, 18, 14, 11, 13, 14, 10, 16,  6]],
	["Geitz", 			[ 3, 40, 17, 12, 13, 10, 11,  3, 13,  6]],
	["Geitz (Hard)", 	[ 3, 44, 19, 13, 14, 10, 12,  4, 13,  6]],
	["Farina", 			[12, 24, 10, 13, 14, 10, 10, 12,  5,  7]],
	["Pent", 			[ 6, 33, 18, 21, 17, 14, 11, 16,  8,  6]],
	["Louise", 			[ 4, 28, 12, 14, 17, 16,  9, 12,  6,  6]],
	["Karel", 			[ 8, 31, 16, 23, 20, 15, 13, 12,  9,  6]],
	["Harken",			[ 8, 38, 21, 20, 17, 12, 15, 10, 11,  6]],
	["Harken (Hard)",	[ 8, 42, 23, 22, 18, 12, 16, 11, 11,  6]],
	["Nino", 			[ 5, 19,  7,  8, 11, 10,  4,  7,  3,  5]],
	["Jaffar", 			[13, 34, 19, 25, 24, 10, 15, 11,  8,  6]],
	["Vaida", 			[ 9, 43, 20, 19, 13, 11, 21,  6, 12,  8]],
	["Vaida (Hard)", 	[ 9, 47, 22, 21, 14, 11, 22,  7, 12,  8]],
	["Karla", 			[ 5, 29, 14, 21, 18, 16, 11, 12,  7,  6]],
	["Renault", 		[16, 43, 12, 22, 20, 10, 15, 18,  9,  6]],
	["Athos", 			[20, 40, 30, 24, 20, 25, 20, 28,  9,  6]]
]);

const promotionGains = new Map([
	["Lyn", 			[3, 2, 2, 0, 0, 3, 5, 1, 1]],
	["Lyn (E/H)", 		[3, 2, 2, 0, 0, 3, 5, 1, 1]],
...
const charCaps = new Map([
	...
	["Nils/Ninian", 	[60, 10, 10, 30, 30, 24, 26, 20, 15]],
	...
	for (let i = baseLevel-1; i < levelCap - 1; i++){
		...
		for (let j = 0; j < 9; j++){
			...
			if (this["current"+stats[j]] < charCaps.get(char)[j]){
				...
				if (this["current"+stats[j]] + statIncrease > charCaps.get(char)[j]){
					statIncrease = charCaps.get("Unpromoted")[j] - this["current"+stats[j]];
				}
			}
			this["current"+stats[j]] += statIncrease;
			this["current"+stats[j]] = Math.round(this["current"+stats[j]] * 100) / 100;
